...
public class EolApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User user1 = new User("Gabriel", "biel.muitoloko@gmail.com", "123456","175673", ps.encode("123"));
		userRepository.save(user1);
		User user2 = new User("Caio", "caio.muitoloko@gmail.com", "123456","175673", ps.encode("123"));
